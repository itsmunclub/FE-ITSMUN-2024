...
const Footer = () => {
  return (
    <div className="bg-MUN-englishViolet max-w-360 w-full sm:max-h-[242px] md:py-[60px] md:px-[115px] sm:py-9 sm:px-11 py-7 px-8 px-">
      <div className="containerr w-full h-full m-auto">
        <div className="content flex sm:flex-row flex-col h-full justify-around">
          <div className="2sm:self-center">
            <img className="items-center w-auto h-auto" src="/footerLogo.svg" alt="Footer Logo"/>
          </div>
          <div className="flex flex-col font-montserrat md:text-xl text-lg justify-around sm:text-center text-left text-MUN-sidebar-linen gap-2">
            <Link href="/" className="">
              Home
            </Link>
